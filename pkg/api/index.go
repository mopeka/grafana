...
func setIndexViewData(c *m.ReqContext) (*dtos.IndexViewData, error) {
	...
	data.NavTree = append(data.NavTree, &dtos.NavLink{
		Text:         "Help",
		SubTitle:     fmt.Sprintf(`TankCheck v%s (%s)`, setting.BuildVersion, setting.BuildCommit),
		Id:           "help",
		Url:          "#",
		...
		Children: []*dtos.NavLink{
			...
			{Text: "Buy more sensors", Url: "http://mopeka.com/products/", Icon: "fa fa-fw fa-comment", Target: "_blank"},
			{Text: "Sensor Help", Url: "http://mopeka.com/homepage/instructions/", Icon: "fa fa-fw fa-file", Target: "_blank"},
		},
	})
